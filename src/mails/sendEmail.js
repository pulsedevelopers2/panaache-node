              ...
              <table style="width:100% !important;border-collapse:collapse;">
                ...
                <tr>
                  <td class="content" style="background-color:white;background-image:none;background-repeat:repeat;background-position:top left;background-attachment:scroll;padding-top:20px;padding-bottom:0;padding-right:20px;padding-left:20px;">
                    ...
                    <p style="font-size:14px;font-weight:normal;margin-bottom:20px;">Thank you for your order! A record of your purchase information appears below. Please keep this email as the confirmation of your order.</p>
        
        <p style="font-size:18px;font-weight:bold;margin-bottom:20px;">ORDER INFORMATION</p>
        
        <p style="font-size:14px;font-weight:normal;margin-bottom:20px;">Order Date: 2021-01-01<br>Order ID: ${orderid} <br>Paid with: Credit card - Visa ending in 6500</p>
        <p style="font-size:14px;font-weight:normal;margin-bottom:20px;">If you have questions about this order, you can simply reply to this email with your questions and we will get back to you shortly with an answer. You can access a printable receipt for all of your transactions in <a href="">your account</a>.</p>
        
        <p style="font-size:14px;font-weight:normal;margin-bottom:20px;">Thanks again for your business! We appreciate that you've chosen us.</p>
        
        <!-- signature begin -->
        <p style="font-size:14px;font-weight:normal;margin-bottom:20px;">Thanks,</p>
        <p style="font-size:14px;font-weight:normal;margin-bottom:20px;">panaache</p>
